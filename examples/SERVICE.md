...
## Overview
<!-- handoverkit:id=overview hash=f686961d5e50 sources=README.md,package.json -->
**handover-kit**
...
| `src/providers` | 3 | `src` |
| `tests` | 9 | `src`, `src/core`, `src/core/parsers` |
...
## Known Issues
<!-- handoverkit:id=known-issues hash=815390638991 sources=src,src/cli.ts,src/core,src/core/check.ts,src/core/config.ts,src/core/generate.ts,src/core/hash.ts,src/core/notes.ts,src/core/parsers,src/core/parsers/ci.ts,src/core/parsers/codeowners.ts,src/core/parsers/env.ts,src/core/parsers/fsUtil.ts,src/core/parsers/imports.ts,src/core/parsers/packageJson.ts,src/core/parsers/walk.ts,src/core/sections.ts,src/marker.ts,src/providers,src/providers/GithubProvider.ts,src/providers/GitlabProvider.ts,src/providers/VcsProvider.ts,tests,tests/architecture.test.ts,tests/config.test.ts,tests/deployment.test.ts,tests/hash.test.ts,tests/issues.test.ts,tests/notes.test.ts,tests/parsers.test.ts,tests/roundtrip.test.ts,tests/scanned-sources.test.ts -->
...
_None found in the 27 scanned source files._
