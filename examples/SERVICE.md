...
## Overview
<!-- handoverkit:id=overview hash=33d4870aa125 sources=README.md,package.json -->
**handover-kit**
...
## Known Issues
<!-- handoverkit:id=known-issues hash=cbb554573817 sources=src/cli.ts,src/marker.ts,src/core/check.ts,src/core/generate.ts,src/core/hash.ts,src/core/sections.ts,src/core/parsers/ci.ts,src/core/parsers/codeowners.ts,src/core/parsers/env.ts,src/core/parsers/fsUtil.ts,src/core/parsers/packageJson.ts,src/core/parsers/walk.ts,src/providers/GithubProvider.ts,src/providers/GitlabProvider.ts,src/providers/VcsProvider.ts,tests/hash.test.ts,tests/parsers.test.ts,tests/roundtrip.test.ts -->
_No TODO/FIXME markers found in the 18 scanned source files._
