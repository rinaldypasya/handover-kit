...
## Overview
<!-- handoverkit:id=overview hash=e80c024c901f sources=README.md,package.json -->
**handover-kit**
...
## Architecture
<!-- handoverkit:id=architecture hash=8c2124b7a06a sources=src/cli.ts,src/marker.ts,src/core/check.ts,src/core/config.ts,src/core/generate.ts,src/core/hash.ts,src/core/notes.ts,src/core/sections.ts,src/core/parsers/ci.ts,src/core/parsers/codeowners.ts,src/core/parsers/env.ts,src/core/parsers/fsUtil.ts,src/core/parsers/imports.ts,src/core/parsers/packageJson.ts,src/core/parsers/walk.ts,src/providers/GithubProvider.ts,src/providers/GitlabProvider.ts,src/providers/VcsProvider.ts,tests/architecture.test.ts,tests/config.test.ts,tests/deployment.test.ts,tests/hash.test.ts,tests/issues.test.ts,tests/notes.test.ts,tests/parsers.test.ts,tests/roundtrip.test.ts -->
...
| `src/providers` | 3 | `src` |
| `tests` | 8 | `src`, `src/core`, `src/core/parsers` |
...
## Known Issues
<!-- handoverkit:id=known-issues hash=8c2124b7a06a sources=src/cli.ts,src/marker.ts,src/core/check.ts,src/core/config.ts,src/core/generate.ts,src/core/hash.ts,src/core/notes.ts,src/core/sections.ts,src/core/parsers/ci.ts,src/core/parsers/codeowners.ts,src/core/parsers/env.ts,src/core/parsers/fsUtil.ts,src/core/parsers/imports.ts,src/core/parsers/packageJson.ts,src/core/parsers/walk.ts,src/providers/GithubProvider.ts,src/providers/GitlabProvider.ts,src/providers/VcsProvider.ts,tests/architecture.test.ts,tests/config.test.ts,tests/deployment.test.ts,tests/hash.test.ts,tests/issues.test.ts,tests/notes.test.ts,tests/parsers.test.ts,tests/roundtrip.test.ts -->
...
_None found in the 26 scanned source files._
